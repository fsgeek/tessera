...
| E5 | Capstone composition context with discharge matrix | A3 §A3.3 (verbatim gate); ENUM §3; TRK cross-cutting box 2 | **partial** — E5a: `formal/suite/LEDGER.md` (PROPOSED, 2026-09-15, fifth draft) enters the 34 offered entries under A7 §A7.10; four Codex full reviews and one skeptic read applied (`docs/reviews/2026-09-14-codex-review-ledger-and-k6.md`, `2026-09-15-codex-full-review-ledger*.md`), all findings accepted; 29 scratch severing runs archived in `formal/suite/ledger-tests-2026-09-14/`. Default reading: matrix D3–D11 (9 rows), 6 firm, 3 whose producer must be registered in the capstone (C-Q7/C-Q8/C-Q9), 6 NOT YET SHOWN (consumer is the capstone); D1/D2 held out pending R-1×R-2; D12/D13 pending R-3. §6 is the capstone contract (C-Q1 as a per-link contract, C-Q2–C-Q9, companions C-C1–C-C10), to be re-verified by a non-author pass before the capstone's predictions freeze. `capstone.pv` absent | author confirm/overrule of R-1, R-2, R-3 (LEDGER.md §5, combined-consequences table); then capstone `PREDICTIONS.md` from §6, non-author review, freeze commit, build (E5b–d) |
